#!/usr/bin/env python3
"""
Quick Queue-DB Test Script
Tests the queue-db schema without test data loading
"""
...
def main():
    print("🧪 Queue-DB Quick Test Suite")
    print("=" * 40)
    ...
    print("\n3. Building Queue-DB Docker image...")
    ...
    # Test 4: Start the container without test data
    print("\n4. Starting Queue-DB container...")
    success, stdout, stderr = run_command("docker run -d --name queue-db-test -e POSTGRES_DB=queue-db -e POSTGRES_USER=queue-admin -e POSTGRES_PASSWORD=queue-pwd -e USE_DEMO_DATA=False -p 5434:5432 queue-db-test")
    ...
    print("\n🎉 Queue-DB Quick Test Suite Complete!")
    print("=" * 40)
    print("\n📋 Test Summary:")
