...
"""
Accouts service manages user account creation, user login, and related tasks. [userservice]
And also manages internal user contacts and external accounts.   [contactservice]
"""
...
def create_app():
    ...
    def create_user():
        ...
        try:
            ...
            if accounts_db.get_user(req['username']) is not None:
            ...
            accountid = accounts_db.generate_accountid()
            ...
            accounts_db.add_user(user_data)
    ...
    def login():
        ...
        try:
            ...
            user = accounts_db.get_user(username)
            if user is None:
    ...
    def get_contacts(username):
        ...
        try:
            ...
            contacts_list = accounts_db.get_contacts(username)
    ...
    def add_contact(username):
        ...
        try:
            ...
            accounts_db.add_contact(contact_data)
    ...
    def _check_contact_allowed(username, accountid, req):
        ...
        for contact in accounts_db.get_contacts(username):
    ...
    def _shutdown():
        ...
        app.logger.info("Stopping accounts service.")

    # Set up logger
    app.logger.handlers = logging.getLogger('gunicorn.error').handlers
    app.logger.setLevel(logging.getLogger('gunicorn.error').level)
    app.logger.info('Starting accounts service.')
    ...
    app.logger.debug("Setting up Accounts DB connection...")
    try:
        accounts_db = AccountsDb(os.environ.get("ACCOUNTS_DB_URI"), app.logger)
